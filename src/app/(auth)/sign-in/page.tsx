        ...
        <div className="relative text-center px-12">
          ...
          >
            <h2 className="text-4xl font-bold mb-4">
              Turn Data into <span className="gradient-text">Stories</span>
            </h2>
            <p className="text-muted-foreground max-w-md">
              Create stunning visualizations, get AI-powered insights, and share
              your data stories with the world.
            </p>
          </motion.div>
        </div>
      </div>
