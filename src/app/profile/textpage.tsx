...
const showcaseProjects = [
  {
    id: 1,
    title: 'Auralink - SaaS Landing Page',
    views: '1.4K',
    likes: 268,
    badge: 'Free',
  ...
  {
    id: 2,
    title: 'Spark - Agency Landing Portfolio',
    views: '319',
    likes: 91,
    badge: 'Free',
  ...
  {
    id: 3,
    title: 'YourSaaS - SaaS Landing Page',
    views: '139',
    likes: 45,
    badge: 'Free',
  ...
  {
    id: 4,
    title: 'Krono/Arch - Modern Architecture Portfolio',
    views: '55',
    likes: 16,
    badge: 'Free',
    ...
    <div style={styles.container}>
      <div style={styles.maxWidth}>
        <div style={styles.profileSection}>
          ...
          <div style={styles.profileInfo}>
            <div style={styles.nameSection}>
              <h1 style={styles.name}>ituadesign</h1>
            ...
            <div style={styles.statsBox}>
              ...
              <span style={styles.statsNumber}>972</span>
            </div>
          </div>
        </div>
        ...
        <div style={styles.showcaseSection}>
          <h2 style={styles.showcaseTitle}>Showcase</h2>
